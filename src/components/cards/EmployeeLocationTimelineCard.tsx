        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-2">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <path
                  d="M11 38.5H16V45.5H11V38.5ZM40.5 17C40.375 19.5 39.5 22 37.75 24C36 25.875 33.75 27.125 30.5 27.75V45.5H27V38.5H23.5V45.5H19.5V28C18.875 28.25 18.375 28.5625 18 28.9375C16 30.5 15 32.375 15 34.75V35.375H11.25V34.75C11.25 31.375 12.75 28.625 16 26.5C19.25 24.5 23.125 23.5 27.5 23.5C30.75 23.5 32.875 22.75 34.125 21.25C35.625 19.375 36.375 17 36.375 14.125V13.375H40.5V17ZM33.125 23.875C32.125 24.875 30.875 25.375 29.375 25.375C27.875 25.375 26.625 24.875 25.625 23.875C24.625 22.875 24.125 21.625 24.125 20.125C24.125 18.625 24.625 17.4375 25.625 16.5C26.625 15.5 27.875 15 29.375 15C30.875 15 32.125 15.5 33.125 16.5C34.125 17.4375 34.625 18.625 34.625 20.125C34.625 21.625 34.125 22.875 33.125 23.875Z"
                  fill="#4766E5"
                />
              </svg>
              {/* Green vertical bar */}
