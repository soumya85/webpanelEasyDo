        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-2">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              {/* Custom User Icon - Large size to match "29" number */}
              <svg
                width="48"
                height="48"
                viewBox="0 0 50 51"
              ...
              >
                <path
                  d="M8 40H14V49H8V40ZM42 15.5C41.875 18.5 40.9375 21 39.1875 23C37.4375 24.875 35.125 26.125 32.25 26.75V49H28V40H24V49H19.75V26.5C19.125 26.75 18.625 27.0625 18.25 27.4375C16.25 29 15.25 31.125 15.25 33.75V35H10.5V33.75C10.5 29.5 12 26 15 23.25C18 20.625 21.75 19.3125 26.25 19.3125C29.125 19.3125 31.25 18.4375 32.625 16.6875C34.25 14.6875 35.0625 12.1875 35.0625 9.1875V8H42V15.5ZM30.75 22.5C29.75 23.5 28.5 24 27 24C25.5 24 24.25 23.5 23.25 22.5C22.25 21.5 21.75 20.25 21.75 18.75C21.75 17.25 22.25 16.0625 23.25 15.125C24.25 14.125 25.5 13.625 27 13.625C28.5 13.625 29.75 14.125 30.75 15.125C31.75 16.0625 32.25 17.25 32.25 18.75C32.25 20.25 31.75 21.5 30.75 22.5Z"
                  fill="#4766E5"
                />
              </svg>
              {/* Green vertical bar */}
