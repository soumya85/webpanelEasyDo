        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm mb-2">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <path
                  d="M10.5 39H17V47H10.5V39ZM41.5 16.5C41.375 19.75 40.3125 22.5 38.3125 24.75C36.3125 26.875 33.5 28.25 30 28.9375V47H26.5V39H22.75V47H18.25V27.25C17.5 27.5625 16.9375 27.9375 16.5625 28.375C14.375 30.125 13.25 32.5 13.25 35.375V36.125H9V35.375C9 31.75 10.75 28.75 14.25 26.375C17.75 24.125 22 22.9375 27 22.9375C30.5 22.9375 33 22 34.5 20.125C36.25 17.9375 37.125 15.125 37.125 11.6875V10.75H41.5V16.5ZM33.75 24.75C32.625 25.875 31.1875 26.4375 29.4375 26.4375C27.6875 26.4375 26.25 25.875 25.125 24.75C24 23.625 23.4375 22.1875 23.4375 20.4375C23.4375 18.6875 24 17.3125 25.125 16.25C26.25 15.125 27.6875 14.5625 29.4375 14.5625C31.1875 14.5625 32.625 15.125 33.75 16.25C34.875 17.3125 35.4375 18.6875 35.4375 20.4375C35.4375 22.1875 34.875 23.625 33.75 24.75Z"
                  fill="#4766E5"
                />
              </svg>
              {/* Green vertical bar */}
