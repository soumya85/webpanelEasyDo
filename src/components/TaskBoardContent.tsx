  ...
  return (
    <div className="h-full flex flex-col min-h-0 bg-gradient-to-br from-blue-100 via-blue-50 to-blue-200">
      ...
      <div className="w-full flex flex-col gap-0 bg-white border-b shadow-sm">
        ...
        {/* --- Status Count Card (Custom Design) or Insight Panel --- */}
        <div className="w-full flex justify-center items-center py-4 bg-white border-b gap-4">
          {/* Status Card or Insight Panel */}
          {showInsight ? (
          ...
          {/* Toggle Button */}
          <button
            className={`ml-8 px-4 py-2 rounded-full text-sm font-semibold transition shadow-sm border-2 focus:outline-none focus:ring-2 focus:ring-yellow-400 ${
              showInsight
