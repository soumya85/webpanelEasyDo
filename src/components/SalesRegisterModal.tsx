...
const branchData = [
  ...
  },
  {
    ...
    name: "Head office",
    description: "",
    address: "104, 3rd Floor , Shyama Prasad Mukherjee Road, Hazra, Kalighat, Kalighat, Kolkata, West Bengal 700026, India"
  },
  {
    id: "haldia",
    name: "Haldia",
    description: "",
    address: "33GG+34V, Sukanta Nagar, WARD NO:15, Haldia, West Bengal 721657, India"
  },
  {
    id: "ahmedabad",
  ...
  },
  {
    ...
    name: "New Delhi",
    description: "",
    address: "New Delhi,405, District Centre, Janakpuri, New Delhi, Delhi, 110058, India"
  }
];
...
export const SalesRegisterModal: React.FC<SalesRegisterModalProps> = ({
  ...
  const filteredEmployees = useMemo(() => {
    let filtered = employeeData.filter(emp => {
      ...
      // Filter by branch
      if (selectedBranch !== "all" && emp.branch.toLowerCase() !== getBranchName(selectedBranch).toLowerCase()) return false;
    ...
    if (sortBy === "alphabetically") {
      ...
      filtered.sort((a, b) => new Date(a.doj).getTime() - new Date(b.doj).getTime());
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-y-auto p-0 gap-0 [&>button]:hidden !translate-y-[-60%] !top-[40%]">
        ...
        <div className="p-4 space-y-4">
          ...
          >
            <span className="text-gray-900">{getBranchName(selectedBranch)}</span>
              ...
              <div key={employee.id} className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        {employee.position} <span className="text-blue-500">({employee.branch})</span>
                      </p>
                      <div className="flex items-center gap-4 mt-2">
                        <span className="text-sm text-gray-600">DOJ : {employee.doj}</span>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-1 px-3 py-1 border border-blue-200 rounded-full">
                    ...
                    <span className="text-sm text-blue-500">{employee.rating} (0)</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <SheetContent side="bottom" className="h-[90vh]">
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="flex gap-2">
                ...
                <Input placeholder="Mobile" className="flex-1 bg-gray-100 border-none" />
              </div>

              <Input placeholder="Email" className="bg-gray-100 border-none" />
              <Input placeholder="Employee Code" className="bg-gray-100 border-none" />

              <div className="relative">
                <Input placeholder="Date Of Birth" className="bg-gray-100 border-none pr-12" />
                <Calendar className="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
              </div>

              <Input placeholder="Designation" className="bg-gray-100 border-none" />
              ...
              <p className="text-sm text-gray-600">
                Note: Attendance, approvals request will be send reporting manager when it is send directly from company dashboard.
              </p>
            </div>
          </SheetContent>
        </Sheet>
