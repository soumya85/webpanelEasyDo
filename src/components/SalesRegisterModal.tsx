...
export const SalesRegisterModal: React.FC<SalesRegisterModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-y-auto !p-0 !gap-0 [&>button]:hidden !translate-y-[-60%] !top-[40%] relative">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b bg-white z-10 absolute top-0 left-0 right-0 rounded-t-lg">
