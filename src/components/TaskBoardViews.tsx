  ...
  const CompactTaskCard = ({ task }: { task: Task }) => (
    ...
    >
      <div className="flex items-start justify-between mb-2">
        <h4 className="font-medium text-gray-900 text-sm leading-tight flex-1 mr-2">{task.title}</h4>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={`text-xs px-2 py-0 ${getStatusBadgeColor(task.status)}`}>
                        {task.status.replace('-', ' ')}
                      </Badge>
                    </div>
                  </div>
            ...
            <div className="p-4">
              <div className="grid grid-cols-7 gap-1 mb-2">
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                  <div key={day} className="p-2 text-center text-xs font-medium text-gray-600 border-b">
                    {day}
                  </div>
                ))}
              </div>
              <div className="grid grid-cols-7 gap-1">
                {Array.from({ length: 35 }, (_, i) => {
                  ...
                  return (
                    <div key={i} className="h-20 border border-gray-100 p-1 bg-gray-50">
              ...
              <div className="min-w-[900px] p-4">
                ...
                <div className="grid" style={{ gridTemplateColumns: `200px repeat(${totalDays}, 1fr)` }}>
                  ...
                  {Array.from({ length: totalDays }).map((_, i) => {
                    ...
                    return (
                      <div key={i} className="text-xs text-gray-500 text-center border-l">
                ...
                {filteredTasks.map((task) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {Array.from({ length: totalDays - startOffset - duration }).map((_, i) => (
                        <div key={i} />
                      ))}
                    </div>
                  );
            ...
            <div className="flex-1 overflow-auto">
              <table className="w-full min-w-[900px]">
                <thead className="sticky top-0 z-10 bg-gray-50 border-b">
                  <tr>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Task</th>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Status</th>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Priority</th>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Assignee</th>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Due Date</th>
                    <th className="p-3 text-xs font-semibold text-gray-600 text-left">Progress</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredTasks.map((task) => (
                    ...
                    <div className="bg-gray-50 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="font-medium text-sm text-gray-700">TO DO</h3>
                    ...
                    <div className="bg-gray-50 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="font-medium text-sm text-gray-700">IN PROGRESS</h3>
                    ...
                    <div className="bg-gray-50 rounded-lg">
                      <div className="p-3 border-b border-gray-200 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="font-medium text-sm text-gray-700">COMPLETE</h3>
                          <Badge variant="secondary" className="text-xs">{completeTasks.length}</Badge>
                        </div>
                        <Button 
                          variant="ghost" 
                          size="sm" 
