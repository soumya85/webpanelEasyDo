                ...
                <div className="flex justify-center mb-8">
                  <div className="relative w-full max-w-[280px] h-[152px] flex justify-center items-center">
                    ...
                    >
                      ...
                      <path
                        d="M123.323 135.061C123.098 125.92 130.324 118.318 139.465 118.093C142.768 118.018 145.865 118.9 148.493 120.496C153.148 123.33 156.301 128.398 156.432 134.235C156.676 143.376 149.45 150.977 140.291 151.221C131.169 151.447 123.567 144.22 123.323 135.061Z"
                        fill="#1E3A5F"
                      />
