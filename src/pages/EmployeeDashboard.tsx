    ...
    <div className={cn("w-full p-3 sm:p-4 lg:p-6 font-inter")}>
      ...
      >
        <DialogContent className="max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
                ...
                {isNotesExpanded && (
                  <div className="space-y-2">
                    <Textarea
                      ...
                      className="min-h-[120px] resize-none focus:ring-2 focus:ring-[#4766E5] focus:border-[#4766E5] transition-all"
                    />
                  </div>
                )}
              </div>
          ...
          <div className="mt-6 pt-4 flex flex-row justify-start space-x-2 border-t bg-white sticky bottom-0 -mx-6 px-6 pb-2">
            <Button
      ...
      <Dialog open={isLeaveCalendarOpen} onOpenChange={setIsLeaveCalendarOpen}>
        <DialogContent className="max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto p-0 flex flex-col">
          <VisuallyHidden>
