...
export default function EmployeeDashboard() {
  ...
  return (
    <div className={cn("w-full p-3 sm:p-4 lg:p-6 font-inter")}>
      ...
      >
        <DialogContent className="max-w-md mx-auto max-h-[95vh] overflow-y-auto p-0 [&>button]:hidden">
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b bg-gray-50">
            <button
              onClick={() => setIsOTRequestModalOpen(false)}
              className="flex items-center text-[#4766E5] text-lg font-medium"
            >
              <svg
            ...
            <button
              onClick={() => setIsOTRequestModalOpen(false)}
              className="text-[#4766E5] text-lg font-medium"
            >
              Submit
            </button>
          </div>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              <Input
                placeholder="Title"
                className="w-full h-12 text-base border-gray-300 rounded-lg"
              />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg">
                <span className="text-base text-[#283C50]">Start date</span>
                <div className="flex items-center space-x-2">
                  <span className="text-[#4766E5] text-base">18 Jun 2025</span>
                  <svg
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-base text-[#283C50]">
                    Notes (Optional)
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-[#4766E5] text-base">None</span>
                  <svg
                    className="w-5 h-5 text-[#4766E5]"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="space-y-2">
              <button
                onClick={() => setIsAttachmentModalOpen(true)}
                className="flex items-center space-x-3 text-[#4766E5] text-base w-full text-left"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
      ...
      {/* OT Request Attachment Options Modal */}
      <Dialog
        open={isAttachmentModalOpen}
        onOpenChange={setIsAttachmentModalOpen}
      >
        <DialogContent className="max-w-md mx-auto p-0 [&>button]:hidden">
          {/* Options List */}
          <div className="bg-white rounded-t-lg p-4 space-y-0">
            <button
              onClick={() => {
                handleAttachmentSelect("scan");
                setIsAttachmentModalOpen(false);
              }}
              className="w-full flex items-center space-x-4 p-4 border-b border-gray-200 hover:bg-gray-50 transition-colors"
            >
              <div className="w-8 h-8 bg-[#4766E5] rounded flex items-center justify-center">
                <svg
              ...
              <span className="text-base text-[#4766E5] font-medium text-left">
                Scan
              </span>
            </button>
            ...
            <button
              onClick={() => {
                handleAttachmentSelect("documents");
                setIsAttachmentModalOpen(false);
              }}
              className="w-full flex items-center space-x-4 p-4 border-b border-gray-200 hover:bg-gray-50 transition-colors"
            >
          ...
          {/* Cancel Button */}
          <div className="bg-white rounded-b-lg p-4 border-t-8 border-gray-100">
            <button
              onClick={() => setIsAttachmentModalOpen(false)}
              className="w-full p-4 text-[#4766E5] text-base font-medium hover:bg-gray-50 rounded-lg transition-colors"
            >
              Cancel
            </button>
          </div>
