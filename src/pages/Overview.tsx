  ...
  return (
    <div
      className={cn(
        ...
        "px-3 pt-4 pb-4 sm:px-5 sm:pt-5 sm:pb-5 lg:px-6 lg:pt-6 lg:pb-6",
    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-4 flex-1">
        ...
        <div className="flex-shrink-0 relative">
          <div
            className={cn(
              "flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 lg:w-18 lg:h-18",
              "bg-[#1a1a1a] rounded-full text-white font-bold text-lg sm:text-xl lg:text-2xl",
            )}
          >
            SP
          </div>
          {/* Person Badge Icon */}
          <div className="absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-[#4766E5] rounded-full flex items-center justify-center">
            <svg
              width="12"
              height="12"
              viewBox="0 0 24 24"
        ...
        <div className="flex flex-col flex-1 min-w-0 justify-center">
          <div className="flex items-center justify-between mb-2">
            <h4 className="text-[#1a1a1a] font-inter text-[16px] sm:text-[17px] lg:text-[18px] font-bold leading-tight truncate">
              Sanjay Patel
            </h4>
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              <span className="text-[#10B981] font-inter text-[12px] sm:text-[13px] font-medium">
                (0)
              </span>
            </div>
          </div>

          <p className="text-[#6B7280] font-inter text-[13px] sm:text-[14px] lg:text-[15px] font-normal leading-tight mb-2 truncate">
            Ahmedabad office Branch
          </p>

          <div className="text-[#6B7280] font-inter text-[13px] sm:text-[14px] lg:text-[15px] font-normal">
