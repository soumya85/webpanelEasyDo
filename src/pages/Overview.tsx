            ...
            <DropdownMenuContent align="end" className="w-48">
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  <ArrowUp className={cn("h-3 w-3", sortBy === "date" && sortOrder === "asc" ? "text-blue-600" : "text-gray-400")} />
                  <ArrowDown className={cn("h-3 w-3", sortBy === "date" && sortOrder === "desc" ? "text-blue-600" : "text-gray-400")} />
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
