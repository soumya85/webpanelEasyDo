export const translations = {
  ...
  Hindi: {
    ...
    viewAllMyTasks: "मेरे सभी कार्य देखे���",
    ...
    holidayNotice: "छुट्टी ��ी सूचना - दिवाली समारोह",
    officeWillRemainClosed: "दिवाली के लिए 24 अक्टूबर को कार्यालय बंद रहेगा...",
    newHealthInsurancePolicy: "नई स्वास्थ्य ��ीमा नीति अपडेट",
    importantUpdatesRegarding:
    ...
    punchIn: "पंच इन",
    punchActionsTracked: "उपस्थ��ति के लिए पंच कार्य ट्रैक किए जाते हैं",
    ...
    dragCardsBetweenSections:
      "पुनर्गठन के लिए कार्ड को सेक्शन के बीच या सेक्शन के भीतर ड्रैग करें - चौड़ाई संरक्षित रहत��� है",
    dropCardsOnPurpleZones:
    ...
    useResetLayoutButton:
      'डिफ़ॉल्ट व्यवस्था को पुनर्स���थापित करने के लिए "रीसेट लेआउट" बटन का उपयोग करें',
  },
  Bengali: {
    // Authentication
    ...
    meetingsThisWeek: "এই সপ্তাহের মি��িং",
    ...
    confirmDelete: "আপনি কি নিশ্��িত যে এই আইটেমটি মুছতে চান?",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "উন্নত ড্রাগ & ড্রপ + ��্রস্থ রিসাইজ নির্দেশাবলী",
    hoverOverCardInstructions:
  ...
  Telugu: {
    ...
    dragBlueResizeHandle:
      "కార్డ్ వెడల్పును సర్దుబాటు చేయడానికి కుడి��ైపు నీలి రీసైజ్ హ్యాండిల్‌ను డ్రాగ్ చేయండి (చిన్న, మధ్యమ, పెద్ద, అదనపు పెద్ద)",
    sameRowEqualHeight:
  ...
  Marathi: {
    ...
    layoutSavedAutomatically:
      "तुमचे लेआउट आणि कार्ड आकार आपोआप जतन केले जातात आणि सत्रांमध्ये कायम राहतात",
    useResetLayoutButton:
  ...
  Tamil: {
    ...
    seconds: "வினாடிகளில்",
    verifyOTP: "OTP ஐ சரிபார்��்கவும்",
  ...
  Punjabi: {
    ...
    termsAndConditions: "ਨਿਯਮ ਅਤੇ ਸ਼ਰਤਾ��",
    and: "ਅਤੇ",
