export const translations = {
  ...
  Bengali: {
    ...
    myPerformance: "আ���ার পারফরম্যান্স",
  ...
  Telugu: {
    ...
    dragCardsBetweenSections:
      "పునర్వ్యవస్థీకరణ కోసం విభాగాల మధ్య లేదా విభాగాలలో కార్డులను డ్రాగ్ చేయండి - వెడల్పు భద్రపరచ��డుతుంది",
    dropCardsOnPurpleZones:
      "విభాగంలో కొత్త వరుసలు సృష్టించడానికి ఊదా జోన్‌లపై కార్డులను డ్రాప్ చేయండి",
    dropCardsOnGreenZones:
      "విభాగం చివరిలో కొత్త వరుసలను జోడించడానికి ఆకుప���్చ జోన్‌లపై కార్���ులను డ్రాప్ చేయండి",
    dragBlueResizeHandle:
    ...
    newBadge: "కొత్త",
    groupBadge: "గ్రూప్",
    viewAllChats: "అన్ని చాట్‌లను చూ��ండి",
  ...
  Marathi: {
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "सुधारित ड्रॅग & ड्रॉप + ���ुंदी रीसाइझ सूचना",
    hoverOverCardInstructions:
  ...
  Gujarati: {
    ...
    followUpOnClientProposal: "��્લાયંટ પ્રસ્તાવ પર ફોલો અપ",
  ...
  Kannada: {
    ...
    bySigningUp: "ಸೈನ್ ಅಪ್ ಮಾ��ುವ ಮೂಲಕ, ನೀವು ನಮ್ಮ",
    ...
    reviewQ4BudgetAllocation: "Q4 ಬಜ���ಟ್ ಹಂಚಿಕೆ ಪರಿಶೀಲನೆ",
    ...
    dragCardsBetweenSections:
      "ಮರುಸಂಘಟನೆಗಾಗಿ ವಿಭಾಗಗಳ ನಡುವೆ ಅಥವಾ ವಿಭಾಗಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರ್ಯಾ���್ ಮಾಡಿ - ಅಗಲವನ್ನು ಸಂರಕ್ಷಿಸಲಾಗುತ್ತದೆ",
    dropCardsOnPurpleZones:
    ...
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ��ಲ್ಲಾ ಕಾರ್ಡ್‌ಗಳು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸಮಾನ ಎತ್ತರವನ್ನು ನಿರ್ವಹಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
  ...
  Odia: {
    ...
    hoverOverCardInstructions:
      "ଡ୍ରାଗ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଟପ୍ ସେଣ୍ଟର୍) ଏବଂ ଓସାର ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଡାହାଣ ଧାର) ଦେଖିବା ପାଇଁ ଯେକୌଣସି କାର୍ଡ ଉପରେ ହୋଭର୍ କରନ୍ତୁ",
    dragCardsBetweenSections:
    ...
    dropCardsOnGreenZones:
      "ବିଭାଗର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା ପାଇଁ ସବୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ ��ରନ୍ତୁ",
    dragBlueResizeHandle:
    ...
    useResetLayoutButton:
      'ଡିଫଲ୍ଟ ବ୍ୟବସ୍ଥା ��ୁନଃସ୍ଥାପନ କରିବା ପାଇଁ "ରିସେଟ୍ ଲେଆଉଟ୍" ବଟନ୍ ବ୍ୟବହାର କର��୍ତୁ',
  },
  Punjabi: {
    ...
    addedHoursAgo: "{hours} ਘੰਟੇ ਪਹਿਲਾ��� ਸ਼ਾਮਲ ਕੀਤਾ ਗਿਆ",
  ...
  Malayalam: {
    ...
    hoverOverCardInstructions:
      "ഡ്രാഗ് ഹാൻഡിൽ (ടോപ്പ് സെന്റർ) ഉം വീതി ���ീസൈസ് ഹാൻഡിൽ (വലത് അരികിൽ) ഉം കാണാൻ ഏതെങ്കിലും കാർഡിൽ ഹോവർ ചെയ��യുക",
    dragCardsBetweenSections:
