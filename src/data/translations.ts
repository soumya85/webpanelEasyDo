export const translations = {
  ...
  Hindi: {
    ...
    late: "देर से",
    redFlag: "लाल झंडा",
    viewDetailedReport: "विस्तृत रिपोर्ट द��खें",
    asOn: "की स्थिति",
    ...
    importantUpdatesRegarding:
      "कंपनी स्वास���थ्य बीमा नीति के संबंध में महत्वपूर्ण अपडेट...",
    ...
    hoverOverCardInstructions:
      "ड्रैग हैंडल (टॉप सेंटर) और चौड़ाई रीसाइज़ ह���ं���ल (दाईं ओर) देखने के लिए किसी भी कार्ड पर होवर करें",
    dragCardsBetweenSections:
    ...
    layoutSavedAutomatically:
      "आपका लेआउट और कार्ड आकार स्वचालित रूप से सहेजे जाते हैं और ��त्रों में बने रहते हैं",
    useResetLayoutButton:
  ...
  Bengali: {
    ...
    salaryOverview: "বেতনের সংক্ষিপ��তসার",
    ...
    viewPerformanceDetails: "��ারফরম্যান্স বিবরণ দেখুন",
    ...
    hoverOverCardInstructions:
      "ড্রাগ হ্যান্ডেল (টপ সেন্টার) এবং প্রস্থ রিসাইজ হ্যান্ড��ল (ডান প্রান্ত) দেখতে যেকোনো কার্ডের উপর হোভার করুন",
    dragCardsBetweenSections:
    ...
    layoutSavedAutomatically:
      "আপ���ার লেআউট এবং কার্ডের আকার স্বয়ংক্রিয়ভাবে সংরক্ষিত হয় এবং সেশন জু��়ে বহাল থাকে",
    useResetLayoutButton:
  ...
  Telugu: {
    ...
    confirmDelete: "మీరు ఖచ్చితం��ా ఈ అంశాన్ని తొలగించాలనుకుం���ున్నారా?",
    ...
    addedHoursAgo: "{hours} గంటల క్రితం జోడించబడిం���ి",
  ...
  Marathi: {
    ...
    dragBlueResizeHandle:
      "कार्डची रुंदी समायोजित करण्यासाठी उ���व्या बाजूचे निळे रीसाइझ हँडल ड्रॅग करा (लहान, मध्यम, म��ठे, अतिरिक्त मोठे)",
  ...
  Tamil: {
    ...
    hoverOverCardInstructions:
      "இழுத்��ுச் செல்லும் கைப்பிடி (மேல் மைய��்) மற்றும் அகல மறுஅளவு கைப்பிடி (வலது விளிம்பு) காண எந்த அட்டையின் மீதும் நகர்த்தவும்",
    dragCardsBetweenSections:
  ...
  Gujarati: {
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "ઉન્નત ડ્રેગ એન��ડ ડ્રોપ + પહોળાઈ રીસ��ઇઝ સૂચનાઓ",
    hoverOverCardInstructions:
  ...
  Kannada: {
    ...
    termsAndConditions: "ನಿಯಮಗಳು ಮತ್ತು ಷರತ��ತುಗಳ���",
    and: "ಮತ್ತು",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "ವರ್ಧಿತ ಡ್ರ್ಯಾಗ್ ಮತ್ತು ಡ್ರ��ಪ�� + ಅ��ಲ ಮರುಗಾತ್ರೀಕರಣ ಸೂಚನೆಗಳು",
    hoverOverCardInstructions:
  ...
  Odia: {
    ...
    dropCardsOnGreenZones:
      "ବିଭାଗର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା ପାଇଁ ସ���ୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dragBlueResizeHandle:
  ...
  Punjabi: {
    ...
    addedDaysAgo: "{days} ਦਿਨ ਪਹਿਲਾਂ ਸ਼ਾਮਲ ਕੀਤਾ ਗ�����",
  ...
  Malayalam: {
    ...
    dropCardsOnPurpleZones:
      "വിഭാഗത്തിൽ പുതിയ വരികൾ സൃഷ���ടിക്കാൻ പർപ്പിൾ സോണുകളിൽ കാർഡുകൾ ഡ്രോപ്പ് ചെയ്യുക",
    dropCardsOnGreenZones:
