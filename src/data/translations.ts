export const translations = {
  ...
  Hindi: {
    ...
    errorMessage: "एक त्रुटि हुई है। कृपया फिर से क���शिश करें।",
    ...
    letsScheduleCallTomorrow: "कल कॉल शेड्यूल करते है��",
    ...
    followUpOnClientProposal: "क्लाइंट प्रस्ताव पर फॉलो अप",
    ...
    useResetLayoutButton:
      'डिफ़ॉल्ट व्यवस्था को पुनर्स्थापित करने के ���िए "रीसेट लेआउट" बटन का उपयोग करें',
  },
  Bengali: {
    // Authentication
    ...
    termsAndConditions: "নিয়�� ও শর্তাবলী",
    and: "এবং",
    ...
    averageOverTaskReviews: "{count} কাজ��র পর্যালোচনার গড়",
    ...
    layoutSavedAutomatically:
      "আপনার লেআউট এবং কার্ডের আকার স্বয়ংক্রিয়ভাবে সংরক্ষিত হয় এবং সেশন জুড়ে বহাল থাকে",
    useResetLayoutButton:
  ...
  Telugu: {
    ...
    viewPerformanceDetails: "పనితీరు వివరాలను చూడండి",
    ...
    hoverOverCardInstructions:
      "డ్రాగ్ హ్యాండిల్ (టాప్ ��ెంటర్) మరియు వెడల్పు రీసైజ్ హ్యాండిల్ (కుడి అంచు) చూడడానికి ఏదైనా కార్డ్‌పై హోవర్ చేయండి",
    dragCardsBetweenSections:
    ...
    sameRowEqualHeight:
      "అదే వరుసలోని అన్ని కార్డులు స్వయంచాలకంగా సమాన ఎత్తును నిర్వహిస్తాయి",
    layoutSavedAutomatically:
  ...
  Marathi: {
    ...
    hoverOverCardInstructions:
      "ड्रॅग हँडल (टॉप सेंटर) आणि रुंदी रीसाइझ हँडल (उजवा किनारा) पाहण्यासाठी कोणत्याही कार्डवर होवर करा",
    dragCardsBetweenSections:
    ...
    layoutSavedAutomatically:
      "तुमचे ल���आउट आणि कार्ड आकार आपोआप जतन केले जातात आणि सत्रांमध्ये कायम राहतात",
    useResetLayoutButton:
      'डिफॉल्ट व्यवस्था पुनर���संचयित करण्यासाठी "रीसेट लेआउट" बटन वापरा',
  },
  Tamil: {
    ...
    hoverOverCardInstructions:
      "இழுத்துச் செல்லும் கைப்பிடி (மேல் மையம்) மற்றும் அகல மறுஅளவு கைப்பிடி (வலது விளிம்பு) காண எந்த அட்டையின் மீதும் நகர்த்தவும்",
    dragCardsBetweenSections:
