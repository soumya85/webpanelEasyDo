export const translations = {
  ...
  Hindi: {
    ...
    dataUpdated: "डेटा सफलतापूर्वक अपड���ट किया गया है",
    ...
    trackedOnlyBetween:
      "(कंपनी के नियम के अनु��ार केवल पंच-इन और पंच-आउट के बीच ���्रैक किया गया)",
    clickHereForMoreDetail: "अधिक विवरण के लिए यहां ��्लिक करें",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions: "उन्नत ड्रैग & ड्रॉप + चौड़ाई आकार निर्द���श",
    hoverOverCardInstructions:
  ...
  Malayalam: {
    ...
    termsAndConditions: "നി��ന്ധനകളും വ്യവസ്ഥകളും",
    and: "ഒപ്പം",
