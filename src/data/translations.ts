export const translations = {
  ...
  Hindi: {
    ...
    officeWillRemainClosed:
      "दि��ाली के लिए 24 अक्टूबर को कार्��ालय बंद रहेगा...",
    ...
    dragBlueResizeHandle:
      "कार्ड की चौ��़ाई समायोजित करने के लिए दाईं ओर नीले ��ीसाइज़ हैंडल को ड्रैग करें (छोटा, मध्यम, बड़ा, अतिरिक्त बड���ा)",
    sameRowEqualHeight:
    ...
    whenEmployeeUpdated:
      "��ब को��� कर्मचारी अपडेट किया जाता है, तो हम जांचते हैं कि क्या कर्मचारी ने एप्लिकेशन ज्वाइन डेट जोड़ी है।",
  ...
  Bengali: {
    ...
    monthlyAttendance: "মাসি�� উপস্থিতি",
    ...
    dataUpdated: "ডেটা সফলভাবে আপডেট হয়��ছে",
    ...
    myPerformance: "আমার পারফরম্যান্স",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "উন্নত ড্রাগ & ড্রপ + প্রস্থ রিসাইজ নির্দেশাবলী",
    hoverOverCardInstructions:
    ...
    notPunchedIn: "পাঞ্চ ইন করা হয়নি",
  ...
  Urdu: {
    ...
    hoverOverCardInstructions:
      "ڈریگ ہینڈل (ٹاپ سینٹر) اور چوڑائی ری سائز ہینڈل (دائیں کنارہ) دیکھنے کے لیے کسی بھی کارڈ پر ہوور کریں",
    dragCardsBetweenSections:
  ...
  Kannada: {
    ...
    dragCardsBetweenSections:
      "ಮರುಸಂಘಟನೆಗಾಗಿ ವಿಭಾ���ಗಳ ನಡುವೆ ಅಥವಾ ವಿಭಾಗಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರ್��ಾಗ್ ಮಾಡಿ - ಅಗಲವ�����್ನು ಸಂರಕ್ಷಿಸಲಾಗುತ್ತದೆ",
    dropCardsOnPurpleZones:
  ...
  Odia: {
    ...
    dragCardsBetweenSections:
      "ପୁନର୍ବ୍ୟବସ୍ଥା ପାଇଁ ବି���ାଗଗୁଡ଼ିକ ମଧ୍ୟରେ କିମ୍ବା ବିଭାଗଗୁଡ଼ିକ ଭିତରେ କାର୍ଡଗୁଡ଼ିକୁ ଡ୍ରାଗ୍ କରନ୍ତୁ - ଓସାର ସଂରକ୍ଷିତ ���ହିଥାଏ",
    dropCardsOnPurpleZones:
