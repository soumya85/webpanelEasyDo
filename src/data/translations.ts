export const translations = {
  ...
  Hindi: {
    ...
    meetingsThisWeek: "इस सप्ताह की बैठके��",
    ...
    dataSaved: "डेटा सफलतापू���्वक सहेजा गया है",
    ...
    letsScheduleCallTomorrow: "कल कॉल शेड्य��ल करते हैं",
  ...
  Bengali: {
    // Authentication
    welcomeToEasyDo: "EasyDo তে আ���নাকে স্বাগতম",
    ...
    employeeDetails: "কর্মচারীর বি���রণ",
    ...
    niceKeepItUp: "চমৎক��র, এভাবেই চালিয়ে যান! 💪",
    ...
    sameRowEqualHeight:
      "একই সারির সব কার্ড ���্বয়ংক্রিয়ভাবে সমান উচ্চতা বজায় রাখে",
    layoutSavedAutomatically:
  ...
  Telugu: {
    ...
    dragBlueResizeHandle:
      "కార్డ్ వెడల్పును సర్దుబాటు చేయడా���ికి కుడివైపు నీలి రీసైజ్ హ్యాండిల్‌ను డ్రాగ్ చేయండి (చిన్న, మధ్యమ, పెద్ద, అదనపు పెద్ద)",
    sameRowEqualHeight:
    ...
    selectChatToStart: "మె���ేజింగ్ ప్రారంభించడానికి చాట్‌ను ఎంచుకోండి",
    online: "ఆన్‌లైన్",
  ...
  Marathi: {
    ...
    hoverOverCardInstructions:
      "ड्रॅग हँडल (टॉप सेंटर) आणि रुंदी रीसाइझ हँडल (उजवा किनारा) पाहण्यासाठी कोणत्याही का����ड��र होवर करा",
    dragCardsBetweenSections:
    ...
    dragBlueResizeHandle:
      "कार्डची रुंदी समायोजित करण्यासाठी उजव्या बाजूचे निळे रीसाइझ हँडल ड्रॅग करा (लहान, मध्यम, म��ठ��, अतिरिक्त मोठे)",
  ...
  Tamil: {
    ...
    addedYesterday: "நேற்று ச��ர்க்கப்பட்டது",
    ...
    dragCardsBetweenSections:
      "மறுசீரமைப்பிற்காக பிரிவுகளுக்கு இடையே அல்லது பிரிவ���களுக்குள் அட்டைகளை இழுக்கவும் - அகலம் பாதுகாக்கப்படு��ிறது",
    dropCardsOnPurpleZones:
    ...
    layoutSavedAutomatically:
      "உங்கள் லேஅவுட் மற்றும் அட்ட��� அளவுகள் தானாகவே சேமிக்கப்பட்டு அமர்வுகள் முழுவதும் நீடிக்கும்",
    useResetLayoutButton:
  ...
  Gujarati: {
    ...
    dropCardsOnPurpleZones:
      "વિભ���ગમાં નવી પંક્તિઓ બનાવવા માટે જાંબલી ઝોનમાં કાર્ડ્સ ડ્રોપ કરો",
    dropCardsOnGreenZones:
  ...
  Kannada: {
    ...
    dragBlueResizeHandle:
      "ಕಾರ್ಡ್ ಅಗಲವನ್ನು ಸರಿಹೊಂದಿಸ���ು ಬಲಭಾಗದ ನೀಲಿ ಮರುಗ��ತ್ರೀಕರಣ ಹ್ಯಾಂಡಲ್ ಅನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾ��ಿ (ಸಣ್ಣ, ಮಧ್ಯಮ, ದೊಡ್ಡ, ಹೆಚ್ಚುವರಿ ದೊಡ್ಡ)",
    sameRowEqualHeight:
  ...
  Odia: {
    ...
    addedYesterday: "ଗତକାଲି ଯୋଗ କରାଯ���ଇଥିଲା",
