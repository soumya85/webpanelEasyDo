export const translations = {
  ...
  Hindi: {
    ...
    performanceMetrics: "प्रदर्शन मेट्रिक्���",
    ...
    confirmLogout: "क्���ा आप वाकई लॉगआउट करना चाहते हैं?",
    ...
    canYouReviewDocument: "क्या आप दस्ताव��ज़ की समीक्षा कर सकते हैं?",
    ...
    addAdditionalNotes:
      "अपन��� छुट्टी अनुरो��� के लिए कोई अतिरि���्त न���ट जोड़ें...",
    addAdditionalInfo:
    ...
    accountDeletionDescription:
      "खाता हटाने का ��नुरोध ��मा किया गय�� है। आपको एक पुष्टिकरण ईमेल प्राप्त होगा।",
  ...
  Bengali: {
    ...
    tomorrowAt: "আগামীকাল",
    minutes: "মিনিট",
    scheduledMeetings: "নির���ধারিত মিটিং",
    ...
    layoutSavedAutomatically:
      "আপন���র লেআউট এবং কার্ডের আকার স্বয়ংক্রিয়��াবে সংরক্ষি��� হয় এবং সেশন জু��়ে বহাল থাকে",
    useResetLayoutButton:
    ...
    documentsUploadedToSharedFolder:
      "শেয���ার করা ফোল্ডারে নথি আপলোড করা হয়েছে",
    ...
    forPunchInClick:
      "পাঞ্চ-ইনের জন্য, উপরে ক্লিক করুন অনুমোদনের জন্য অনুরোধ কর��র চেষ্টা করুন, আপনার রিপোর্টিং ম্যানেজারের কাছে...",
  ...
  Telugu: {
    ...
    totalDelegatedTasks: "మొత్��ం అ��్ప���ించిన పనులు",
    overdue: "గడువు దాటిన",
    ...
    employeeOfTheMonth: "నెలకు ఉద్యో��ి",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "మెరుగైన డ్రాగ్ & ������రాప్ + వెడల్పు రీసైజ్ సూచనలు",
    hoverOverCardInstructions:
  ...
  Marathi: {
    ...
    hoverOverCardInstructions:
      "ड्रॅग हँडल (टॉप सेंटर) आणि रुंदी रीसाइझ हँडल (उजवा कि��ारा) प���हण्यासाठी कोणत्याही का�����डवर होवर करा",
    dragCardsBetweenSections:
    ...
    searchAnnouncement: "ঘোষ��া খুঁজুন",
    ...
    addAdditionalNotes: "আপনার ছুটির অনুরোধের জন্য অতিরিক্ত নোট যো�� ��রুন...",
    addAdditionalInfo:
  ...
  Tamil: {
    ...
    companyDashboard: "நிற��வன டாஷ்போர்டு",
    tasks: "பணிகள்",
    meet: "சந்திப���பு",
    ...
    reviewQ4BudgetAllocation: "Q4 பட்ஜெட் ஒதுக்கீ��ு மதிப்பாய்���ு",
    ...
    dragCardsBetweenSections:
      "��றுசீரமைப்பிற்காக ��ிரிவுகளுக்கு இடையே அல்லது பிரிவுகளுக்குள் அட்டைகளை இழுக்கவும் - அகலம் பாதுகாக்கப்படு��ிறது",
    dropCardsOnPurpleZones:
    ...
    dragBlueResizeHandle:
      "அட்டையின் அகலத்���ை சரிசெய்ய வலது பக்கத்தில் உள்ள நீல மறுஅளவு கைப்பிடிய�� இழுக்கவும் (சிறி���, நடுத்தர, பெரிய, கூடுதல் பெரிய)",
    sameRowEqualHeight:
  ...
  Kannada: {
    ...
    bySigningUp: "ಸೈನ���� ಅಪ್ ಮಾಡುವ ಮೂಲ���, ನೀವು ನಮ್ಮ",
    ...
    dragCardsBetweenSections:
      "ಮರುಸಂಘಟನೆಗಾಗಿ ವಿಭಾಗಗಳ ನಡುವೆ ಅಥವಾ ವಿಭಾಗಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾಡಿ - ಅಗಲವ�����್ನು ಸಂರಕ್ಷಿಸಲಾಗುತ್ತದೆ",
    dropCardsOnPurpleZones:
  ...
  Odia: {
    ...
    hoverOverCardInstructions:
      "ଡ୍ରା��୍ ହ୍ୟାଣ୍ଡଲ୍ (ଟପ୍ ସେଣ୍ଟର୍) ଏବଂ ଓସାର ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଡାହାଣ ଧା��) ଦେଖିବା ପାଇଁ ଯେକୌଣସି ���ାର୍ଡ ଉପରେ ହୋଭର୍ କରନ୍ତୁ",
    dragCardsBetweenSections:
    ...
    dragBlueResizeHandle:
      "କାର୍ଡ ଓସାର ସଜାଡ଼ିବା ପାଇଁ ଡାହାଣ ପାର୍ଶ୍ୱର ନୀଳ ରିସାଇଜ୍ ହ���ୟାଣ୍ଡଲ୍ ଡ୍ରାଗ୍ କରନ୍ତୁ (ଛୋଟ, ମଧ୍ୟମ, ବଡ଼, ଅତିରିକ୍ତ ବଡ଼)",
    sameRowEqualHeight:
  ...
  Malayalam: {
    ...
    tasks: "ജോലികൾ",
    meet: "കൂടിക്കാഴ്ച",
    notesReminder: "കുറിപ്പുകളും ഓർമ്മപ്പെടു���്തലുകളും",
