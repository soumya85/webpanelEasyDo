export const translations = {
  ...
  Hindi: {
    ...
    department: "वि��ाग",
    designation: "पदनाम",
    joiningDate: "ज्व���इनिंग की तारीख",
    ...
    budgetApprovalReceived: "बजट अनु���ोदन प्राप्त हुआ",
    newBadge: "नया",
    groupBadge: "समूह",
    viewAllChats: "सभी चैट देखें",
    searchOrStartNewChat: "खोजें या नई चैट श���रू करें",
    selectChatToStart: "सं��ेश भेजना शुरू करने के लिए एक चैट चुनें",
    online: "ऑनलाइन",
    groupChat: "ग्र���प चैट",
    ...
    punchIn: "पंच इन",
    punchActionsTracked: "उपस्थिति के लिए पंच क���र्य ट्रैक किए जाते है���",
    ...
    viewPerformanceDetails: "प्रदर्शन विवरण ���ेखें",
    ...
    dropCardsOnPurpleZones:
      "सेक्शन ���े भीतर नई पंक��तियां बनाने के लि��� का���्ड को बैंगनी ज़ोन पर ड्रॉप कर��ं",
    dropCardsOnGreenZones:
    ...
    sameRowEqualHeight:
      "एक ही पंक्त�� में सभी कार्ड स्वचालित रूप से समान ऊंचाई बना��� रखते हैं",
    layoutSavedAutomatically:
    ...
    enterCustomTiming: "कस्टम स����य दर्��� कर��ं",
    ...
    searchDocument: "दस्ता��ेज़ खोजें",
    ...
    // Common Field Labels
    selectLocationOnMap: "मान���ित्र पर स्थान चु����ें",
    totalDays: "कुल दिन",
    totalHours: "कुल घंटे",
  ...
  Bengali: {
    ...
    niceKeepItUp: "চমৎকার, এভাবেই ���ালিয়ে যান! 💪",
    ...
    updateTeamOnProjectTimeline: "প্রকল্প সময়সূচীতে ��িম ���প��েট",
    ...
    useResetLayoutButton:
      'ডিফল্ট বিন��যাস পুনরুদ্���ার করতে "রিসেট লেআউট" বোতাম ব্যবহার করুন',
    ...
    selectChatToStart: "মেসেজিং শুরু করতে একটি চ্যাট নির��বাচন করুন",
    online: "অনলাইন",
  ...
  Telugu: {
    ...
    backToLogin: "← ల���గిన్‌కు తిర���గి వెళ్లం��ి",
    ...
    // Section Titles
    quickOverview: "వేగవంతమైన అవలోకన��",
    ...
    dropCardsOnGreenZones:
      "విభాగం చివరిలో కొత్త వరుసలను జోడించడానికి ఆకుప���్చ జోన్‌లపై కార్డులను డ��రాప్ చేయండి",
    dragBlueResizeHandle:
  ...
  Marathi: {
    ...
    dragBlueResizeHandle:
      "��ार्डची रुंद��� समायोजित करण��यासाठी उजव्या बाजूचे निळे रीसाइझ हँडल ड्रॅग करा (लहान, मध्यम, म��ठे, अतिरिक्त मोठे)",
    ...
    pleaseSelect: "অনুগ্রহ করে ��ির্বাচন করুন",
    netPay: "নিট বেতন",
    ...
    addAdditionalInfo:
      "আপনার বেতন অগ্রিমের অনুরোধে�� জন্য অতির���ক্ত তথ্য বা ���্যায্যতা যোগ করুন...",
  },
  Tamil: {
    welcomeToEasyDo: "EasyDo வில் உங்களை வரவேற்க��றோம்",
    ...
    backToLogin: "← உள்நுழைவுக்கு திரும்��வு���்",
    ...
    followUpOnClientProposal: "வாடிக்கையாளர் முன்மொழிவ���ல�� பின்தொடர்தல்",
    ...
    dragBlueResizeHandle:
      "அட்டையின் அகலத்���ை சரிசெய்ய வலது பக்கத்தில் உ���்ள நீல மறுஅளவு கைப்பிடிய�� இழுக்கவும் (சிறிய, நடுத்தர, பெரிய, கூடுதல் பெரிய)",
    sameRowEqualHeight:
    ...
    useResetLayoutButton:
      'இயல்புநிலை ஏற்பாட்டை மீட்டமைக்க "ரீசெட் லேஅவுட்" பொத்தானைப் பயன்படுத்தவும்',
  },
  Urdu: {
    welcomeToEasyDo: "EasyDo میں آپ کا خیرمقد��",
  ...
  Gujarati: {
    ...
    employeeDashboard: "કર���મચારી ડેશબોર્ડ",
    ...
    addedYesterday: "ગઈકાલે ઉમેરવામાં આ��્યું",
    addedDaysAgo: "{days} દિવસ પહેલાં ઉમેરવામાં આવ્યું",
  ...
  Kannada: {
    ...
    updateTeamOnProjectTimeline: "ಪ್ರಾಜೆಕ್ಟ್ ಟೈಮ್‌ಲೈನ್‌ನಲ್ಲಿ ತಂಡದ ��ಪ್‌ಡೇಟ್",
    ...
    dragCardsBetweenSections:
      "ಮರುಸಂಘಟನೆಗಾಗಿ ವಿಭಾಗಗಳ ನಡು���ೆ ಅಥವಾ ವಿಭಾಗಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾಡಿ - ಅಗಲವ�����್ನು ಸಂರಕ್ಷಿಸಲಾಗುತ್ತದೆ",
    dropCardsOnPurpleZones:
    ...
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ����್ಲಾ ಕಾರ್ಡ��‌ಗಳು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸಮಾನ ಎತ್ತರವನ್ನು ನಿರ್ವ��ಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
      "ನಿಮ್ಮ ಲೇಔಟ್ ಮತ್ತು ಕಾರ್ಡ್ ಗಾತ್ರಗಳು ಸ್��ಯಂಚಾಲಿತವಾಗಿ ಉಳಿಸಲ್ಪಡುತ್ತವೆ ಮತ್ತು ಸೆಷನ್‌ಗಳಾದ್ಯಂತ ಮುಂದುವರಿಯುತ್ತವೆ",
    useResetLayoutButton:
  ...
  Odia: {
    ...
    settings: "ସେଟିଂସ୍",
    helpSupport: "ସାହାଯ୍ୟ ଏ��ଂ ସହାୟତା",
    profile: "ପ୍ରୋଫାଇଲ୍",
    logout: "ଲଗଆଉଟ୍",
    ...
    dropCardsOnGreenZones:
      "ବିଭାଗର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା �����ାଇଁ ସବୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dragBlueResizeHandle:
  ...
  Punjabi: {
    welcomeToEasyDo: "EasyDo ਵ���ੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ",
    ...
    dragBlueResizeHandle:
      "ਕਾਰਡ ਦੀ ਚੌੜਾਈ ਨਿਯੰਤਰਿਤ ਕਰਨ ਲਈ ਸੱਜੇ ਪਾਸੇ ਦੇ ਨੀਲੇ ਰੀਸਾਈਜ਼ ਹੈਂਡਲ ਨੂੰ ਡਰੈੱਗ ਕਰੋ (ਛੋਟਾ, ਮ���ਧਮ, ਵੱਡਾ, ਵਾਧੂ ਵੱਡਾ)",
    sameRowEqualHeight:
  ...
  Malayalam: {
    ...
    updateTeamOnProjectTimeline: "പ്രോജക്ട് ടൈംലൈ��ിൽ ടീം അപ��‌ഡേറ്റ്",
    ...
    layoutSavedAutomatically:
      "നിങ്ങളുടെ ലേഔട്ടും കാർഡ് വലുപ്പങ്ങളും സ്വയമേവ സംരക്ഷിക്കപ്പെടുകയും സെഷനു��ളിലുടനീളം നിലനിൽക്കുകയും ചെയ്യുന്നു",
    useResetLayoutButton:
