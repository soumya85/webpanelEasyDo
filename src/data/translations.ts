export const translations = {
  ...
  Hindi: {
    ...
    late: "देर से",
    redFlag: "लाल झंडा",
    viewDetailedReport: "विस्तृत रिपोर्��� देखें",
    asOn: "की स्थिति",
    ...
    // Meetings Card
    weeklyTeamSync: "साप्ताहिक ट���म सिंक",
    ...
    letsScheduleCallTomorrow: "कल कॉल शेड्यूल कर���े हैं",
    ...
    reviewQ4BudgetAllocation: "Q4 बजट आवंटन की समीक्षा",
    updateTeamOnProjectTimeline: "प्रोज���क्ट टाइमलाइन पर टीम को अपडेट",
    addedHoursAgo: "{hours} घंटे पहले जोड़ा गया",
    ...
    dropCardsOnPurpleZones:
      "सेक्शन ���े भीतर नई पंक��तियां बनाने के लि��� कार्ड को बैंगनी ज���ोन पर ड्रॉप करें",
    dropCardsOnGreenZones:
    ...
    // Layout Controls
    layoutAutoSaved: "लेआउट स्वतः सहेजा गया",
    ...
    enterCustomTiming: "कस्टम स���य दर्ज करें",
    ...
    writeAnnouncementDetails: "घोषणा विवरण लिखें",
    reviewerName: "समीक्षक नाम",
    reviewTags: "टीमवर्क, ग��णवत्ता, डिलीवरी",
    ...
    attendMeeting: "मीटिंग में भाग लें",
    salesLead: "सेल्स लीड",
    ...
    duration: "अवधि",
    vendorPaidTo: "विक्���ेता/भुगतान",
    totalAmount: "कुल राशि",
    approvalNoOptional: "अनुमोदन नं. (वैकल्पिक)",
    addAdditionalNotes:
      "अपने छुट्टी अनुरो��� के लिए कोई अतिरिक्त नोट जोड़ें...",
    addAdditionalInfo:
    ...
    noPendingApprovalAvailable: "कोई लंबित अनुमोदन उपलब्ध नहीं",
    noDeniedApprovalAvailable: "कोई अस्वीकृत अनुमोदन उपलब्ध नहीं",

    // Common placeholders and hints
    manageViewAllBranches: "सभी शाखा���ं का प्रबंधन/देखना",
    selectDateToViewLeaves: "उस दिन की छुट्टियां देखने के लिए एक तारीख चुनें",
    noDateSelected: "कोई तारीख चुनी नहीं गई",

    // Notifications
    profileUpdated: "प्रोफाइल अपडेट किय�� गया",
    profileUpdateDescription: "आपका प्रोफाइल सफलतापूर्वक अपडेट किया गया है।",
    accountDeletionDescription:
      "खाता हटाने का अनुरोध जमा किया गय�� है। आपको एक पुष्टिकरण ईमेल प्राप्त होगा।",
  ...
  Bengali: {
    ...
    and: "এবং",
    privacyPolicy: "গ���পনীয়তা নীতি",
    sendOTP: "OTP পাঠান",
    enterOTP: "৬-ড���জিটের OTP প্রবে��� করুন",
    ...
    performanceMetrics: "পারফরম্যান্স মে���্রিক্স",
    ...
    niceKeepItUp: "চমৎকার, এভাবেই চালিয়ে যান! 💪",
    employeeOfTheMonth: "মাসের কর্মচারী",
    viewPerformanceDetails: "পারফরম্যান্স বিবরণ দেখুন",

    // Quick Notes Card
    quickNotes: "দ্র��ত নোট",
    followUpOnClientProposal: "ক্লায়েন্ট প্রস্তাবে ফলো আপ",
    reviewQ4BudgetAllocation: "Q4 বাজেট বরাদ্দ পর্যালোচনা",
    updateTeamOnProjectTimeline: "প্রকল্প সময়সূ��ীতে ��িম আপডেট",
    ...
    hoverOverCardInstructions:
      "ড্রাগ হ্যান্ডেল (টপ সেন্টার) এবং প্রস্থ রিসাইজ হ্যান্ডেল (ডান প্রান্ত) দেখতে যেকোনো কার্ডের উপর হোভার করুন",
    dragCardsBetweenSections:
      "পুনর্গঠনের জন্য সেকশনের মধ্যে বা সেকশনের ভিতরে কার্ড ড্র��গ করুন - প্রস্থ সংরক্ষিত থাকে",
    dropCardsOnPurpleZones:
    ...
    trackedOnlyBetween:
      "(কোম্পানির আদেশ অনুযায়ী শুধুমাত্র পাঞ্চ-ইন এবং পাঞ্চ-আউটের মধ্যে ট্র্যাক করা হয়)",
  ...
  Telugu: {
    ...
    confirmDelete: "మీరు ఖచ్చితం��ా ఈ అంశాన్ని తొలగించాలన��కుంటున్నారా?",
    ...
    asOn: "ప్రకారం",
    nextPayslip: "మీ తదు���రి పేస్లిప్ రూపొందించబడుతుంది",
    days: "రోజులు",
    ...
    addedYesterday: "నిన్న జోడించబడింది",
    addedDaysAgo: "{days} రోజుల క్రితం జోడించబడింది",
    addNewNote: "క��త్త గమనిక జోడించండి",

    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "మెరుగైన డ్రాగ్ & డ్రాప్ + వెడ��్పు రీసైజ్ సూచనలు",
    hoverOverCardInstructions:
      "డ్రాగ్ హ్యాండిల్ (టాప్ సెంటర్) మరి��ు వెడల్పు రీసైజ్ హ్యాండిల్ (కుడి అంచు) చూడడానికి ఏదైనా కార్డ్‌పై హోవర్ చేయ��డి",
    dragCardsBetweenSections:
      "పునర్వ్యవస్థీకరణ కోసం విభాగాల మధ్య లేదా విభాగాలలో కార్డులను ��్రాగ్ చేయండి - వెడల్పు భద్రపరచబడుతుంది",
    dropCardsOnPurpleZones:
    ...
    dragBlueResizeHandle:
      "కార్డ్ వెడల్పును సర్దుబాటు చేయడానికి కుడివైపు నీల�� రీసైజ్ హ్యాండిల్‌ను డ్రాగ్ చేయండి (చిన్న, మధ్యమ, పెద్ద, అదనపు పెద్ద)",
    sameRowEqualHeight:
  ...
  Marathi: {
    ...
    // Quick Notes Card
    quickNotes: "त्वरित नोट्स",
    followUpOnClientProposal: "क्लायंट प्रस्तावावर फॉलो अप",
    ...
    addedDaysAgo: "{days} दिवसांपूर्वी जोडले",
    ...
    dragCardsBetweenSections:
      "पुनर्व्य���स्थापनासाठी विभागांमध्ये किंवा वि���ागांतर्गत कार्डे ड्रॅग करा - रुंदी जतन केली जाते",
    dropCardsOnPurpleZones:
    ...
    layoutSavedAutomatically:
      "तुमचे लेआउट आणि कार्ड आकार आप��आप जतन केले जातात आणि सत्रांमध्ये कायम राहतात",
    useResetLayoutButton:
      'ডিফল্ট বিন্যাস পুনরুদ্ধার করতে "রিসেট লেআউট" বোতাম ব্যবহার করুন',
    ...
    dragResizeCards: "কার্ড টেনে আনুন ও আকার পরিবর্তন করুন",
    ...
    selectContact: "যোগাযোগ নি��্বাচন করুন",
    enterName: "নাম প্রবেশ করুন",
    phoneNumber: "ফোন নম্বর",
    enterEmail: "ইমেইল প্রবেশ করুন",
    enterDesignation: "পদবী প্��বেশ করুন",
    ...
    searchEmployee: "কর্মচারী, শাখা বা পদ খুঁজুন",
    ...
    searchTodaysSchedule: "কাজ, মিটি��, ইভেন্ট খুঁজুন...",
    ...
    enterEmployeeName: "কর্মচারীর নাম প্রবেশ করুন",
    announcementTitle: "ঘোষণার শিরোনাম",
    writeAnnouncementDetails: "ঘোষণার বিবরণ লিখুন",
    reviewerName: "পর্যালোচকের নাম",
    reviewTags: "টিমওয়ার্ক, গুণমান, ডেলিভারি",
    writeBriefSummary: "পর্যালোচনার সংক্ষ���প্ত সারসংক্ষেপ লিখুন",
    takeANote: "একটি নোট নিন...",
    tellUsAboutYourself: "আপনার সম্পর্কে বলুন...",

    // Performance categories
    managementReview: "ব্যবস্থাপনা পর্যালোচনা",
    attendance: "উপস্থিতি",
    ...
    nayanjyotiMandal: "নয়নজ্যোতি মণ্ডল",
    ...
    addAdditionalInfo:
      "আপনার বেতন অগ্রিমের অনুরোধে�� জন্য অতির���ক্ত তথ্য বা ন্যায্যতা যোগ করুন...",
  },
  Tamil: {
    ...
    and: "மற்றும்",
    privacyPolicy: "தனியுரிமை��் கொள்கை",
    ...
    resendOTPIn: "OTP ஐ மீண்டும் அனு��்பவும்",
    seconds: "வினாடிகளில்",
    ...
    followUpOnClientProposal: "வாடிக்கையாளர் முன்மொழிவ���ல் பின்த��டர்தல்",
    reviewQ4BudgetAllocation: "Q4 பட்ஜெட் ஒதுக்கீடு மதிப்பாய்���ு",
    updateTeamOnProjectTimeline: "திட்ட கால அட்டவணையில் குழு புதுப்பிப்பு",
    addedHoursAgo: "{hours} மணி நே���ங்களுக்கு முன்பு சேர்க்கப்பட���டது",
    addedYesterday: "நேற்று சேர்க்கப்பட்டது",
    addedDaysAgo: "{days} நாட்களுக்கு முன்பு சேர்க்கப்பட்டது",
    addNewNote: "புதிய குறிப்பு சேர்க்கவும்",

    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "மேம்படுத்தப்ப���்ட இழுத்து விடுதல் + அகல மறுஅளவு வழிமுறைகள்",
    hoverOverCardInstructions:
      "இழுத்துச் செல்லும் கைப்பிடி (மேல் மைய��்) மற்றும் அகல மறுஅ��வு க���ப்பிடி (வலது விளிம்பு) காண எந்த அட்டையின் மீதும் நகர்த்தவும்",
    dragCardsBetweenSections:
    ...
    dropCardsOnGreenZones:
      "பிரிவின் இறுதியில் புதிய வரிசைகளை சேர்க்க பச்சை பகுதிகளில் அட்டைகளை விடவும்",
    dragBlueResizeHandle:
      "அட்டையின் அகலத்தை சரிசெய்ய வலது பக்கத்தில் உள்ள நீல மறுஅளவு கைப்பிடிய�� இழுக்கவும் (சிறிய, நடுத்தர, பெரிய, கூடுதல் பெரி��)",
    sameRowEqualHeight:
  ...
  Urdu: {
    ...
    dragCardsBetweenSections:
      "دوبارہ ترتیب دینے کے لیے سیکشنز کے درمیان یا سیکشنز کے اندر کارڈز کو ڈریگ کریں - چوڑائی محفوظ رہتی ہے",
    dropCardsOnPurpleZones:
      "سیکشن کے اندر نئی قطاریں بنانے کے لیے جامنی زونز پر کارڈز ڈراپ کریں",
    dropCardsOnGreenZones:
      "سیکشن کے آخر میں نئی قطاریں شامل کرنے کے لیے سبز زونز پر کارڈز ڈراپ کریں",
    dragBlueResizeHandle:
  ...
  Gujarati: {
    ...
    hoverOverCardInstructions:
      "ડ્રેગ હેન્ડલ (ટોપ સેન્ટર) અને પહોળાઈ રીસાઇઝ હેન્ડલ (જમણી કિનારી) જોવા માટે કોઈપણ ક���ર્ડ પર હોવર કરો",
    dragCardsBetweenSections:
  ...
  Kannada: {
    ...
    dragCardsBetweenSections:
      "ಮರುಸಂಘಟನೆಗಾಗಿ ವಿಭಾಗಗಳ ನಡುವೆ ಅಥವಾ ವಿಭಾಗಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾಡಿ - ಅಗಲವನ್ನು ಸಂರಕ್ಷಿಸಲಾಗುತ್ತದೆ",
    dropCardsOnPurpleZones:
      "ವಿಭಾಗದಲ್ಲಿ ಹೊಸ ಸಾಲುಗಳನ್ನು ರಚಿಸಲು ನೇರಳೆ ವಲಯಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗಳನ್ನು ಡ್ರಾಪ್ ಮಾಡಿ",
    dropCardsOnGreenZones:
      "ವಿಭಾಗದ ಕೊನೆಯಲ್ಲಿ ಹೊಸ ಸಾಲುಗಳನ್ನು ಸೇರಿಸಲು ಹಸಿರು ವಲಯಗಳಲ್ಲಿ ಕಾರ್ಡ್���ಗಳನ್ನು ಡ್ರಾಪ್ ಮಾಡಿ",
    dragBlueResizeHandle:
      "ಕಾರ್ಡ್ ಅಗಲವನ್ನು ಸರಿಹೊಂದಿಸ���ು ಬಲಭಾಗದ ನೀಲಿ ಮರುಗ��ತ್ರೀಕರಣ ಹ್ಯಾಂಡಲ್ ಅನ್ನು ಡ್ರ್ಯಾಗ್ ಮಾಡಿ (ಸಣ್ಣ, ಮಧ್ಯಮ, ದೊಡ್ಡ, ಹೆಚ್ಚುವರಿ ದೊಡ್ಡ)",
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ����್ಲಾ ಕಾರ್ಡ್‌ಗಳು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸಮಾನ ಎತ್ತರವನ್ನು ನಿರ್ವಹಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
      "ನಿಮ್ಮ ಲೇಔಟ್ ಮತ್ತು ಕಾರ್ಡ್ ಗಾತ್ರಗಳು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಉಳಿಸಲ್ಪಡುತ್ತವೆ ಮತ್ತು ಸೆಷನ್‌ಗಳಾದ್ಯಂತ ಮುಂದುವರಿಯುತ್ತವೆ",
    useResetLayoutButton:
      'ಪೂರ್ವ���ಿಗದಿ ವ್ಯವಸ್ಥೆಯನ್ನು ಮ���ುಸ್ಥಾಪಿಸಲು "ರೀಸೆಟ್ ಲೇಔಟ್" ಬಟನ್ ಬಳಸಿ',
  },
  Odia: {
    ...
    followUpOnClientProposal: "କ୍ଲାଏଣ୍ଟ ପ୍ରସ୍ତାବରେ ���ଲୋ ଅପ୍",
    ...
    addedYesterday: "ଗତକାଲି ଯୋଗ କରାଯାଇଥିଲା",
    addedDaysAgo: "{days} ଦିନ ପୂର୍ବରୁ ଯୋଗ କରାଯାଇଥିଲା",
    ...
    hoverOverCardInstructions:
      "ଡ୍ରା��୍ ହ୍ୟାଣ୍ଡଲ୍ (ଟପ୍ ସେଣ୍ଟର୍) ଏବଂ ଓସାର ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଡାହାଣ ଧାର) ଦେଖିବା ପାଇଁ ଯେକୌଣସି କାର୍ଡ ଉପରେ ହୋଭର୍ କରନ୍ତୁ",
    dragCardsBetweenSections:
      "ପୁନର୍ବ୍ୟବସ୍ଥା ପାଇଁ ବିଭାଗଗୁଡ଼ିକ ମଧ୍ୟରେ କିମ୍ବା ବିଭାଗଗୁଡ଼ିକ ଭିତରେ କାର୍ଡଗୁଡ଼ିକୁ ଡ୍ରାଗ୍ କରନ୍ତୁ - ଓସାର ସଂରକ୍ଷିତ ରହିଥାଏ",
    dropCardsOnPurpleZones:
      "ବିଭାଗରେ ନୂଆ ଧାଡ଼ି ସୃଷ୍ଟି କରିବା ପାଇଁ ବାଇଗଣୀ ��ୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dropCardsOnGreenZones:
      "ବିଭାଗର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା ପାଇଁ ସବୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dragBlueResizeHandle:
      "କାର୍ଡ ଓସାର ସଜାଡ଼ିବା ପାଇଁ ଡାହାଣ ପାର୍ଶ୍ୱର ନୀଳ ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ ଡ୍ରାଗ୍ କରନ୍ତୁ (ଛୋଟ, ମଧ୍ୟମ, ବଡ଼, ଅତିରିକ୍ତ ବଡ଼)",
    sameRowEqualHeight:
      "ସମାନ ଧାଡ଼ିର ସମସ୍ତ କାର୍ଡ ସ୍ୱୟଂଚାଳିତ ଭାବରେ ସମାନ ଉଚ୍ଚତା ବଜାୟ ରଖନ୍ତି",
    layoutSavedAutomatically:
      "ଆପଣଙ୍କ ଲେଆଉଟ୍ ଏବଂ କାର୍ଡ ଆକାରଗୁଡ଼ିକ ସ୍ୱୟଂଚାଳିତ ଭାବରେ ସଞ���ଚିତ ହୋଇଥାଏ ଏବଂ ସେସନ୍ ଗୁଡ଼ିକରେ ରହିଥାଏ",
    useResetLayoutButton:
  ...
  Punjabi: {
    ...
    dropCardsOnPurpleZones:
      "ਭਾਗ ਵਿੱਚ ਨਵੀਂ ਕਤਾਰਾਂ ਬਣਾਉਣ ਲਈ ਜਾਮਨੀ ਜ਼ੋਨਾਂ 'ਤੇ ਕਾਰਡ ਛੱਡੋ",
    dropCardsOnGreenZones:
      "ਭਾਗ ਦੇ ਅੰਤ ਵਿੱਚ ਨਵੀਂ ਕਤਾਰਾਂ ਸ਼ਾਮਲ ਕ��ਨ ਲਈ ਹਰੇ ਜ਼ੋਨਾਂ 'ਤੇ ਕਾਰਡ ਛੱਡੋ",
    dragBlueResizeHandle:
      "ਕਾਰਡ ਦੀ ਚੌੜਾਈ ਨਿਯੰਤਰਿਤ ਕਰਨ ਲਈ ਸੱਜੇ ਪਾਸੇ ਦੇ ਨੀਲੇ ਰੀਸਾਈਜ਼ ਹੈਂਡ�� ਨੂੰ ਡਰੈੱਗ ਕਰੋ (ਛੋਟਾ, ਮੱਧਮ, ਵੱਡਾ, ਵਾਧੂ ਵੱਡਾ)",
    sameRowEqualHeight:
