export const translations = {
  ...
  Hindi: {
    ...
    dragCardsBetweenSections:
      "पुनर्गठन के लिए कार्ड को सेक्शन के बीच या सेक्शन के भीतर ड्रैग करें - चौड��ाई संरक्षित रहती है",
    dropCardsOnPurpleZones:
    ...
    useResetLayoutButton:
      'डिफ़ॉल्ट व्���वस्था को पुनर्स्थापित करने के लिए "रीसेट लेआउट" बटन का उपयोग करें',
  },
  Bengali: {
    // Authentication
  ...
  Telugu: {
    ...
    dataSaved: "డేటా విజ���వంతంగా సేవ్ చేయబడింది",
    ...
    dragBlueResizeHandle:
      "కార్డ్ వెడల్పును సర్దుబాటు చేయడానికి కుడివైపు నీలి రీసైజ్ హ్యాండిల్‌ను డ్రాగ�� చేయండి (చిన్న, మధ్యమ, పెద్ద, అదనపు పెద్ద)",
    sameRowEqualHeight:
  ...
  Tamil: {
    ...
    backToLogin: "← உள���நுழைவுக்கு திரும்பவும்",
  },
  Urdu: {
  ...
  Kannada: {
    ...
    backToLogin: "�� ಲಾಗಿನ್‌ಗೆ ಹಿಂತಿರ���ಗಿ",
  },
  Odia: {
