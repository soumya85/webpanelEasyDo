export const translations = {
  ...
  Bengali: {
    ...
    confirmLogout: "আপনি কি নিশ্চিত যে লগআউট করতে চা��?",
  ...
  Tamil: {
    ...
    mobileNumberPlaceholder: "மொபைல��� எண்",
  ...
  Punjabi: {
    ...
    bySigningUp: "ਸਾਈਨ ਅੱਪ ਕਰਕੇ, ਤੁਸੀ�� ਸਾਡੀ",
