export const translations = {
  ...
  Hindi: {
    ...
    clientReviewMeeting: "क्लाइंट स��ीक्षा बैठक",
    todayAt: "आज",
    tomorrowAt: "कल",
    minutes: "मिनट",
    ...
    forPunchInClick:
      "पंच-इन के लिए, ऊपर क्लिक करें अपने रिपोर्टिंग मैनेजर स��� अनुमोदन का अनुरोध करें...",
    ...
    dropCardsOnGreenZones:
      "सेक्शन के अंत में नई पंक्तियां जोड��ने के लिए कार्ड को हरे ज़ोन पर ड्रॉप करें",
    dragBlueResizeHandle:
    ...
    useResetLayoutButton:
      'डिफ़ॉल्ट व्यवस्था को पुनर्स्थापित करने के लिए "रीसेट लेआउट" बटन का उपयोग करें',
  },
  Bengali: {
    // Authentication
    ...
    // Section Titles
    quickOverview: "দ্রুত পর্যালো���না",
    ...
    dataUpdated: "ডেটা ���ফলভাবে আপডেট হয়েছে",
    ...
    hoverOverCardInstructions:
      "ড্রাগ হ্যান্ডেল (টপ সেন্টার) এবং প্রস্থ রিসাইজ হ্যান্ডেল (ডান প্রান্ত) দেখতে যেকোনো কার্ডের উপর হো��ার করুন",
    dragCardsBetweenSections:
    ...
    layoutSavedAutomatically:
      "আপনার লেআউট এবং কার্ডের আকার স্বয়ংক্রিয়ভাবে সংরক্ষিত হয় এ���ং সেশন জুড়ে বহাল থাকে",
    useResetLayoutButton:
  ...
  Gujarati: {
    ...
    termsAndConditions: "��િયમો અને ��રતો",
    and: "અને",
  ...
  Punjabi: {
    ...
    mobileNumberPlaceholder: "ਮੋਬਾਈਲ ��ੰਬਰ",
