export const translations = {
  ...
  Hindi: {
    ...
    thanksForUpdate: "अपडे��� के लिए धन्��वाद!",
    ...
    trackedOnlyBetween:
      "(कंपनी के नियम के अनु��ार केवल ���ंच-���न और पंच-आउट के बीच ट्रैक किया गया)",
  ...
  Bengali: {
    ...
    overdue: "বিলম্বিত",
    dueToday: "আজ দেয়",
    pendingReview: "পর্যালোচনা মুলতুব���",
    ...
    dropCardsOnGreenZones:
      "সেকশনের ��েষে নতুন সারি যোগ করতে সবু�� জোনে কার্ড ড্রপ করুন",
    dragBlueResizeHandle:
    ...
    filesReadyForDownload: "ফাইলগুলি ডাউনলোডের জ���্য প্রস্তুত",
  ...
  Telugu: {
    ...
    viewAllMyTasks: "నా అన్ని పనులను చ��డండి",
    ...
    employeeOfTheMonth: "న���లకు ఉద్యోగి",
  ...
  Marathi: {
    ...
    dragBlueResizeHandle:
      "कार���डची रुंद��� समायोजित करण��यासाठी उजव्या बाजूचे निळे रीसाइझ हँडल ड्रॅग करा (लहान, मध्यम, म��ठे, अतिरिक्त मोठे)",
  ...
  Urdu: {
    ...
    layoutSavedAutomatically:
      "آپ کا لے آؤٹ اور کارڈ سائز خودکار ط��ر پر محفو�� ہو جاتے ہیں اور س��شنز میں برقرار رہتے ہیں",
    useResetLayoutButton:
  ...
  Kannada: {
    ...
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ����್ಲಾ ಕಾರ್ಡ��‌ಗಳು ಸ್ವಯಂಚಾಲಿ��ವಾಗಿ ಸಮಾನ ಎತ್ತರವನ್ನು ನಿರ್ವಹಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
  ...
  Odia: {
    ...
    addedDaysAgo: "{days} ଦ��ନ ପୂର୍ବରୁ ଯୋଗ କରାଯାଇଥି��ା",
    ...
    dropCardsOnGreenZones:
      "ବିଭା���ର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା �����ାଇଁ ସବୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dragBlueResizeHandle:
