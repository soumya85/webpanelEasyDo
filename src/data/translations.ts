export const translations = {
  ...
  Hindi: {
    ...
    mobileNumberPlaceholder: "मोबाइल नं��र",
  ...
  Telugu: {
    welcomeToEasyDo: "EasyDo కు స్వ���గతం",
  ...
  Marathi: {
    ...
    mobileNumberPlaceholder: "मोबाईल न��बर",
  ...
  Kannada: {
    ...
    bySigningUp: "ಸೈನ್ ಅಪ್ ಮಾಡುವ ಮ��ಲಕ, ನೀವು ನಮ್ಮ",
