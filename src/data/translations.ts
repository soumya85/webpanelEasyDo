export const translations = {
  ...
  Hindi: {
    ...
    asOn: "की स्थिति",
    nextPayslip: "आपकी अगली पेस���लिप बनाई जाएगी",
    days: "दिन",
    deducted: "कटौती",
    ...
    clickHereForMoreDetail: "अधिक विवरण के लिए यहां क्लिक करे��",
    ...
    addedDaysAgo: "{days} दिन प��ले जोड़ा गया",
  ...
  Bengali: {
    ...
    performanceMetrics: "পারফরম্যা���্স মেট্রিক্স",
    ...
    reviewQ4BudgetAllocation: "Q4 বা���েট বরাদ্দ পর্যালোচনা",
    ...
    layoutSavedAutomatically:
      "আপনার লেআউট এবং কার্ডের আকার স্বয়ংক্রিয়ভাবে সংরক্ষিত হয় এবং ��েশন জু��়ে বহাল থাকে",
    useResetLayoutButton:
  ...
  Telugu: {
    ...
    tasks: "కార్యాలు",
    meet: "మీ��్",
    notesReminder: "గమనిక��ు & రిమైండర్",
    reports: "రిపోర్ట్స్",
    ...
    employeeOfTheMonth: "నెలకు ఉద��యోగి",
    ...
    addedHoursAgo: "{hours} గంటల క్��ితం జోడించబడింది",
    ...
    dragCardsBetweenSections:
      "పునర్వ్యవస్థీకరణ కోసం విభాగాల మధ్య లేదా విభాగాలలో కార్డులను డ���రాగ్ చేయండి - వెడల్పు భద్రపరచబడుతుంది",
    dropCardsOnPurpleZones:
    ...
    layoutSavedAutomatically:
      "మీ లేఅవుట్ మరియు కార్డ్ పరిమాణ���లు స్వ��ంచాలకంగా సేవ్ చేయబడతాయి మరియు సెషన్‌లలో కొనసాగుతాయి",
    useResetLayoutButton:
    ...
    noChatsAvailable: "���ాట్‌లు అందుబాటులో లేవు",
  },
  Marathi: {
    ...
    updateTeamOnProjectTimeline: "प्रकल्प वेळापत्रकावर टीम ���पडेट",
    ...
    dragCardsBetweenSections:
      "पुनर्व्यवस्थापनासाठी विभागांमध्ये किंवा वि���ागांतर्गत कार्डे ड्रॅग करा - रुंदी जतन केली जात��",
    dropCardsOnPurpleZones:
  ...
  Urdu: {
    ...
    and: "اور",
    privacyPolicy: "رازداری کی پالی��ی",
    sendOTP: "OTP بھیجیں",
    ...
    layoutSavedAutomatically:
      "آپ کا لے آؤٹ اور کارڈ سائز خودکار طور ��ر محفو�� ہو جاتے ہیں اور سیشنز میں برقرار رہتے ہیں",
    useResetLayoutButton:
  ...
  Kannada: {
    ...
    hoverOverCardInstructions:
      "ಡ್���್ಯಾಗ್ ಹ್ಯಾಂಡಲ್ (ಮೇಲಿನ ಮಧ್ಯ) ಮತ್ತು ಅಗಲ ಮರುಗಾತ್ರೀಕರಣ ಹ್ಯಾಂಡಲ್ (ಬಲ ಅಂಚು) ನೋಡಲು ಯಾವ���ದೇ ಕಾರ್ಡ್ ಮೇಲೆ ಹೋವರ್ ಮಾಡಿ",
    dragCardsBetweenSections:
    ...
    dropCardsOnGreenZones:
      "ವಿಭಾಗದ ಕೊನೆಯಲ್ಲಿ ಹೊಸ ಸಾಲುಗಳನ್ನು ಸೇರಿಸಲು ಹಸಿರು ವಲಯಗಳಲ್ಲಿ ಕಾರ್ಡ್‌ಗ��ನ್ನು ಡ್ರಾಪ್ ಮಾಡಿ",
    dragBlueResizeHandle:
  ...
  Odia: {
    ...
    dragCardsBetweenSections:
      "ପୁନର୍ବ୍ୟବସ୍ଥା ପାଇଁ ବିଭାଗଗୁଡ଼ିକ ମଧ୍ୟରେ କିମ୍ବା ବିଭାଗଗୁଡ଼ିକ ଭିତରେ କାର୍ଡଗୁଡ଼ିକୁ ଡ୍ରାଗ୍ କରନ��ତୁ - ଓସାର ସଂରକ୍ଷିତ ରହିଥାଏ",
    dropCardsOnPurpleZones:
  ...
  Malayalam: {
    ...
    resendOTP: "OTP വ��ണ്ടും അയയ്ക്കുക",
    ...
    dropCardsOnPurpleZones:
      "വിഭാഗത്തിൽ പുതിയ വരികൾ സൃഷ്ടിക്കാൻ പർപ്പിൾ സോണുകളി�� കാർഡുകൾ ഡ്രോപ്പ് ചെയ്യുക",
    dropCardsOnGreenZones:
    ...
    layoutSavedAutomatically:
      "നിങ്ങളുടെ ലേഔട്ടും കാർഡ് വലുപ്പങ്ങളും സ്വയമേവ സംരക്ഷിക്കപ്പെടുകയും സെഷനുകളിലുടനീളം നിലനിൽക്കുകയും ചെ���്യുന്നു",
    useResetLayoutButton:
