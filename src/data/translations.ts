export const translations = {
  ...
  Hindi: {
    ...
    confirmDelete: "क्या आप ���ाक��� इस आइटम को हटाना चाहते हैं?",
    ...
    viewDelegatedTasks: "स���ं���े गए कार्�� देखे���",
    myTask: "मेरा कार्य",
    ...
    forPunchInClick:
      "पंच-इन के ल��ए, ऊपर क्लिक करें अपने रिपोर्टिंग म���नेजर से अनुमोदन का अनुरोध करें...",
    ...
    dragCardsBetweenSections:
      "पुनर्गठन के लिए कार���ड को सेक्शन क�� बीच या सेक्शन के भीतर ड्रैग करें - चौड़ाई संरक्षित रहती है",
    dropCardsOnPurpleZones:
    ...
    accountDeletionDescription:
      "खाता हटाने का अनुरोध ��मा कि���ा गय�� है। आपको एक पुष्टिकरण ईमेल प्राप्त होगा।",
  ...
  Bengali: {
    ...
    authorityLevel: "কর্তৃত্বের স্��র",
    welcome: "স্বাগতম",
    ...
    myPerformance: "আম��র পারফরম্যান্স",
  ...
  Telugu: {
    ...
    confirmDelete: "మీరు ఖచ్చిత�����ా ఈ అంశాన్ని తొలగించాలనుకుంట��న్నారా?",
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "మెరుగైన డ్రాగ్ & ���్రాప్ + వెడల్ప�� రీసైజ్ సూచనలు",
    hoverOverCardInstructions:
  ...
  Marathi: {
    ...
    dragCardsBetweenSections:
      "��ुनर्व्य���स्थापनासाठी विभागांमध्य��� किं��ा वि���ागांतर्गत कार्डे ड्रॅग करा - रुंदी जतन केली जाते",
    dropCardsOnPurpleZones:
  ...
  Tamil: {
    ...
    bySigningUp: "பதிவு செய்வதன் மூலம், ���ீங்கள் எங்கள்",
  ...
  Urdu: {
    ...
    dropCardsOnGreenZones:
      "سیکشن کے آخر میں نئی قطاریں شا��ل کرنے کے ��یے سبز ز��نز پر کارڈز ڈراپ کریں",
    dragBlueResizeHandle:
  ...
  Punjabi: {
    ...
    dragBlueResizeHandle:
      "ਕਾਰਡ ਦੀ ਚੌੜਾਈ ਨਿਯੰਤਰਿਤ ਕਰਨ ਲਈ ਸੱਜੇ ਪਾਸੇ ਦੇ ਨੀਲੇ ਰੀਸਾਈਜ਼ ਹੈਂਡਲ ਨੂੰ ਡਰੈੱਗ ਕ���ੋ (ਛੋਟਾ, ਮ���ਧਮ, ਵੱਡਾ, ਵਾਧੂ ਵੱਡਾ)",
    sameRowEqualHeight:
  ...
  Malayalam: {
    ...
    dropCardsOnPurpleZones:
      "വിഭാഗത്തിൽ പുതിയ വരികൾ സൃഷ്ടിക്കാ�� പർപ്പിൾ സോണുകളിൽ കാർ��ുകൾ ഡ്രോപ്പ് ചെയ്യുക",
    dropCardsOnGreenZones:
