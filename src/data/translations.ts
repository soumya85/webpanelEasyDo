export const translations = {
  ...
  Hindi: {
    ...
    selectChatToStart: "सं��ेश भेजन��� शुरू करने के लिए एक चैट चुनें",
    online: "ऑनलाइन",
    groupChat: "ग्र���प चैट",
    ...
    trackedOnlyBetween:
      "(कंपनी के निय�� के अनु��ार केवल ���ंच-इन और पंच-आउट के बीच ट्रैक किया गया)",
    ...
    dropCardsOnGreenZones:
      "सेक्शन के अंत में नई पंक्ति���ां जोड़ने के लिए कार्ड को हरे ज़ोन पर ड्रॉप ��रें",
    dragBlueResizeHandle:
    ...
    searchDocument: "दस्तावेज़ खोज���ं",
    ...
    writeAnnouncementDetails: "घोषणा विवर��� ���िखें",
  ...
  Bengali: {
    ...
    totalDelegatedTasks: "���োট অর্পিত কাজ",
    overdue: "বিলম্বিত",
    dueToday: "আজ দেয়",
    ...
    viewPerformanceDetails: "প���রফর���্যান্স বিবরণ দেখুন",
  ...
  Telugu: {
    ...
    sendOTP: "OTP పం���ండి",
    enterOTP: "6-అంకెల OTP న�� ఎంటర్ చేయండి",
    sentTo: "పంపబడింది",
    resendTo: "పునర్ పంపణ",
    ...
    recentActivity: "ఇటీవలి కార్యకలాప���లు",
    ...
    clientReviewMeeting: "క్లయింట్ �����వ్యూ మీటింగ్",
    todayAt: "ఈరోజు",
    tomorrowAt: "రేపు",
    minutes: "నిమిషాలు",
  ...
  Marathi: {
    ...
    searchEmployeeLeave: "কর্মচারী, শাখা বা কারণ খুঁজু���",
  ...
  Tamil: {
    ...
    addedYesterday: "நேற்று சேர்க்கப்பட்ட��ு",
    addedDaysAgo: "{days} நாட்களுக்கு முன்பு சேர்க்கப்��ட்டது",
    ...
    dropCardsOnGreenZones:
      "���ிரிவின் இறுதியில் புதிய வரிசைக��ை சேர்க்க பச்சை பகுதிகளில் அட்டைகளை விடவும்",
    dragBlueResizeHandle:
      "அட்டையின் அகல��்���ை சரிசெய்ய வலது பக்கத்தில் உள்ள நீல மறுஅளவு கைப்பிடிய�� இழுக்கவும் (சிறிய, நடுத்தர, பெரிய, கூடுதல் பெரிய)",
    sameRowEqualHeight:
  ...
  Urdu: {
    ...
    dropCardsOnGreenZones:
      "سیکشن کے آخر میں نئی قطاریں شا��ل کرنے کے لیے سبز ز��نز پر کارڈز ڈراپ کر��ں",
    dragBlueResizeHandle:
  ...
  Punjabi: {
    ...
    addedDaysAgo: "{days} ਦਿਨ ਪਹਿਲਾਂ ਸ਼���ਮਲ ਕੀਤਾ ਗ��ਆ",
  ...
  Malayalam: {
    ...
    // Drag & Drop Instructions
    enhancedDragDropInstructions:
      "മെച്ചപ്പെടുത്തിയ ഡ്രാ���് & ഡ്രോപ്പ് + വീതി റീസൈസ�� നിർദ്���േശങ്ങൾ",
    hoverOverCardInstructions:
    ...
    dragBlueResizeHandle:
      "കാർഡിന്റെ വീതി ക്രമീക��ിക്കാൻ വലതുവശത്തുള്ള നീല റീസൈസ് ഹാ���ഡിൽ ഡ്രാഗ് ചെയ്യു�� (ചെറുത്, ഇടത്തരം, വലുത്, അധിക വലുത്)",
    sameRowEqualHeight:
