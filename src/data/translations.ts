export const translations = {
  ...
  Hindi: {
    ...
    importantUpdatesRegarding:
      "कंपनी स्वास्थ्य बीमा नीति के स���बंध में महत्वपूर्ण अपडेट...",
    ...
    letsScheduleCallTomorrow: "कल कॉल शेड्यूल ��रते हैं",
    ...
    noChatsAvailable: "कोई चैट उपलब्ध नही��",
    ...
    hoverOverCardInstructions:
      "ड्रैग हैंडल (टॉप सेंटर) और चौड़ाई रीसाइज़ हैं���ल (दाईं ओर) दे��ने के लिए किसी भी कार्ड पर होवर करें",
    dragCardsBetweenSections:
    ...
    sameRowEqualHeight:
      "एक ही पंक्ति में सभी कार्ड स्वचालित रूप से समान ऊ��चाई बनाए रखते हैं",
    layoutSavedAutomatically:
      "आपका लेआउट और कार्ड आकार स्वचालित रूप से सहेजे जाते हैं और सत्रों में बने रहत�� हैं",
    useResetLayoutButton:
    ...
    searchBranchOrLocation: "शाखा या स्थान खो���ें",
    ...
    searchAnnouncement: "घो��णा खोजें",
  ...
  Bengali: {
    ...
    sendOTP: "OTP পাঠান",
    enterOTP: "৬-ড���জিটের OTP প্রবেশ করুন",
    ...
    // Messages
    successMessage: "অপারেশন সফ���ভাবে সম্পন্ন হয়েছে",
    ...
    dropCardsOnGreenZones:
      "সেকশ���ের শেষে নতুন সারি যোগ করতে সবুজ জোনে কার্ড ড্রপ করুন",
    dragBlueResizeHandle:
  ...
  Telugu: {
    ...
    yesterday: "నిన్న",
    executiveDirector: "���ార్యనిర్వాహక డైరెక్టర్",
    ...
    // Leave Management
    leave: "సెలవు",
    applyLeave: "సెలవు కోసం ద���ఖాస్తు చేయండి",
    ...
    averageOverTaskReviews: "{count} కార్య సమీక్షల సగ���ు",
    ...
    addNewNote: "కొత్త గమనిక జోడించండి",
    ...
    selectChatToStart: "మెసేజింగ్ ప్రారంభించడానికి చాట్‌���ు ఎంచుకోండి",
    online: "ఆన్‌లైన్",
  ...
  Marathi: {
    ...
    // Quick Notes Card
    quickNotes: "त्वरित नोट्स",
    followUpOnClientProposal: "क्लायंट प्रस्��ावावर फॉलो अप",
    ...
    hoverOverCardInstructions:
      "ड्रॅग हँडल (टॉप सेंटर) आणि रुंदी रीसाइझ हँडल (उजवा किनारा) पाहण्यासाठी कोणत्याही का����डवर होवर करा",
    dragCardsBetweenSections:
    ...
    dropCardsOnGreenZones:
      "विभागाच्या शेवटी नवीन पंक���ती जोडण्य��साठी हिरव्या झोनवर कार्डे ड्रॉप करा",
    dragBlueResizeHandle:
  ...
  Tamil: {
    ...
    addedHoursAgo: "{hours} மணி நே���ங்களுக்கு முன்பு சேர்க்கப்பட்டது",
    addedYesterday: "நேற்று சேர்க்கப்பட்டது",
    addedDaysAgo: "{days} நாட்கள���க்கு முன்பு சேர்க்கப்பட்டது",
    ...
    useResetLayoutButton:
      'இயல்புநிலை ஏற்பாட்டை மீட்டமைக்க "ரீசெட் லேஅவுட்" பொத்தானைப் ��யன்படுத்தவும்',
  },
  Urdu: {
    ...
    updateTeamOnProjectTimeline: "پروجیکٹ ٹائم لائن پر ٹیم اپڈیٹ",
    ...
    dragBlueResizeHandle:
      "کارڈ کی چوڑائی ایڈجسٹ کرنے کے لیے دائیں طرف نیلے ری سائز ہینڈل کو ڈریگ کریں (چھوٹا، درمیانہ، بڑا، بہت بڑا)",
    sameRowEqualHeight:
  ...
  Gujarati: {
    ...
    layoutSavedAutomatically:
      "તમારું લેઆઉટ અને કાર્ડ સાઇઝ આપમેળે સેવ થાય છે અને સેશનમાં ટકી રહે છે",
    useResetLayoutButton:
  ...
  Kannada: {
    ...
    hoverOverCardInstructions:
      "ಡ್ರ್ಯಾಗ್ ಹ್ಯಾಂಡಲ್ (ಮೇಲಿನ ಮಧ್ಯ) ಮತ್ತು ಅಗಲ ಮರುಗಾತ್ರೀಕರಣ ಹ್ಯಾಂಡಲ್ (ಬಲ ಅಂಚು) ನೋಡಲು ಯಾವ���ದೇ ಕಾರ್ಡ್ ಮೇಲೆ ಹೋವರ್ ಮಾಡಿ",
    dragCardsBetweenSections:
    ...
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ��ಲ್ಲಾ ಕಾರ್ಡ್‌ಗಳು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಸಮಾನ ಎತ���ತರವನ್ನು ನಿರ್ವಹಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
  ...
  Odia: {
    ...
    hoverOverCardInstructions:
      "ଡ୍ରାଗ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଟପ୍ ସେଣ୍ଟର୍) ଏବଂ ଓସାର ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ (ଡାହାଣ ଧାର) ଦେଖିବା ପାଇଁ ଯେକୌଣସି କାର୍ଡ ଉପ��େ ହୋଭର୍ କରନ୍ତୁ",
    dragCardsBetweenSections:
  ...
  Punjabi: {
    ...
    layoutSavedAutomatically:
      "ਤੁਹਾਡਾ ਲੇਆਉਟ ਅਤੇ ਕਾਰਡ ਸਾਈਜ਼ ਆਪਣੇ ਆਪ ਸੇਵ ਹੋ ਜਾਂਦੇ ਹਨ ਅਤੇ ਸੈਸ਼ਨਾਂ ਵਿੱਚ ��ਰਕਰਾਰ ਰਹਿੰਦੇ ਹਨ",
    useResetLayoutButton:
  ...
  Malayalam: {
    ...
    hoverOverCardInstructions:
      "ഡ്രാഗ് ഹാൻഡിൽ (ടോപ്പ് സെന്റർ) ഉം വീതി ���ീസൈസ് ഹാൻഡിൽ (വലത് അരികിൽ) ഉം കാണാൻ ഏതെങ്കിലും കാർഡിൽ ഹോവർ ചെയ്യുക",
    dragCardsBetweenSections:
    ...
    sameRowEqualHeight:
      "ഒരേ വരിയിലുള്ള എല്ലാ കാർഡുകളും സ്വ���മേവ തുല്യ ഉയരം നിലനിർത്തുന്നു",
    layoutSavedAutomatically:
