export const translations = {
  ...
  Hindi: {
    ...
    performanceMetrics: "प्रद��्शन मेट्रिक्स",
    ...
    filesReadyForDownload: "फाइलें ��ाउनलोड के लिए तैय��र हैं",
    ...
    forPunchInClick:
      "पंच-इ��� के लिए, ऊपर क्लिक करें अपने रिपोर्टिंग म���नेजर से अनुमोदन का अनुरोध करें...",
  ...
  Marathi: {
    ...
    dragResizeCards: "কার্��� টেনে আনুন ও আকার পরি���র্তন করুন",
  ...
  Kannada: {
    ...
    sameRowEqualHeight:
      "ಒಂದೇ ಸಾಲಿನಲ್ಲಿರುವ ����್ಲಾ ಕಾರ್ಡ��‌ಗಳು ಸ್ವಯಂಚಾ���ಿತವಾಗಿ ಸಮಾನ ಎತ್ತರವನ್ನು ನಿರ್ವಹಿಸುತ್ತವೆ",
    layoutSavedAutomatically:
  ...
  Odia: {
    ...
    dropCardsOnGreenZones:
      "ବି���ାଗର ଶେଷରେ ନୂଆ ଧାଡ଼ି ଯୋଗ କରିବା �����ାଇଁ ସବୁଜ ଜୋନ୍ ଉପରେ କାର୍ଡ ଡ୍ରପ୍ କରନ୍ତୁ",
    dragBlueResizeHandle:
      "କାର୍ଡ ଓସାର ସଜାଡ଼ିବା ପ��ଇଁ ଡାହାଣ ପାର୍ଶ୍ୱର ନୀଳ ରିସାଇଜ୍ ହ୍ୟାଣ୍ଡଲ୍ ଡ୍ରାଗ୍ କରନ୍ତୁ (ଛୋଟ, ମଧ୍ୟମ, ବଡ଼, ଅତିରିକ୍ତ ବଡ଼)",
    sameRowEqualHeight:
  ...
  Punjabi: {
    ...
    layoutSavedAutomatically:
      "ਤੁਹਾਡਾ ਲੇਆਉਟ ਅਤ�� ਕਾਰਡ ਸਾਈਜ਼ ਆਪਣੇ ਆਪ ਸੇਵ ਹੋ ਜਾਂਦੇ ਹਨ ਅ��ੇ ਸੈ���਼ਨਾਂ ਵਿੱਚ ਬਰਕਰਾਰ ਰਹਿੰਦੇ ਹਨ",
    useResetLayoutButton:
  ...
  Malayalam: {
    ...
    sameRowEqualHeight:
      "ഒരേ വര���യിലുള്ള എല്ലാ കാർഡുകളും ��്വയമേ�� തുല്യ ഉയരം നിലനിർത്തുന്നു",
    layoutSavedAutomatically:
